...
public class institution extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        casulty = FirebaseDatabase.getInstance().getReference().child("Institution_Requests");
        Display();
        ...
        mconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(fullnME)){
                    ...
                    Toast.makeText(institution.this, "Name required", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(mPhone)){
                    mphonenumber.setError("Phone number required");
                    mphonenumber.requestFocus();
                    Toast.makeText(institution.this, "Phone required", Toast.LENGTH_SHORT).show();
                ...
                if(TextUtils.isEmpty(description)){
                    ...
                    Toast.makeText(institution.this, "Description required", Toast.LENGTH_SHORT).show();
                    return;
                }
                            ...
                            query.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                                        ...
                                        Toast.makeText(institution.this, "" + deliverable, Toast.LENGTH_SHORT).show();
                                        if (deliverable.equals("Hospital")){
                                            startActivity(new Intent(institution.this, MainActivity.class));
                                        }
                                        if (deliverable.equals("Insurance")){
                                            startActivity(new Intent(institution.this, com.okolea.MInsurance.MainActivity.class));

                                        }
                                        if (deliverable.equals("Police")){
                                            startActivity(new Intent(institution.this, com.okolea.police.activities.MainActivity.class));
        ...
        if(filePath != null)
        {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Query query = FirebaseDatabase.getInstance().getReference().child("Institution_Requests").limitToLast(1);
                    query.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
...
//                    });
    ...
    public void onBackPressed() {
        super.onBackPressed();
//        Intent intent = new Intent(institution.this, LoginActivity.class);
//        startActivity(intent);
//        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Intent intent = new Intent(institution.this, HomePage.class);
            startActivity(intent);
            finish();
